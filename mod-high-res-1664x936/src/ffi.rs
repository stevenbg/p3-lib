...
const RESOLUTION_STRING: &CStr = c"1664 x 936";
...
static VOLLANSICHTSKARTE: &[u8] = include_bytes!("Vollansichtskarte1664.bmp");
static HAUPTSCREEN_A: &[u8] = include_bytes!("HauptscreenA1664.bmp");
static HAUPTSCREEN_E: &[u8] = include_bytes!("HauptscreenE1664.bmp");
...
pub unsafe extern "thiscall" fn maybe_render_all_objects_hook(this: u32, a2: u32, a3: u32, a4: u32, a5: u32) -> i32 {
    ...
    // The vanilla sidebar art is 1024 tall; only fill the gap below it if the screen is taller
    if res_height > 1024 {
...
pub unsafe extern "cdecl" fn ddraw_dll_decode_supported_files_hook(aim_image_inner: u32, file_path: *const u8, mut file_data: u32, mut file_size: u32) -> i32 {
    ...
    if path.ends_with("Vollansichtskarte1280.bmp") {
        ...
        file_data = VOLLANSICHTSKARTE.as_ptr() as _;
        file_size = VOLLANSICHTSKARTE.len() as _;
        ...
        file_data = HAUPTSCREEN_A.as_ptr() as _;
        file_size = HAUPTSCREEN_A.len() as _;
        ...
        file_data = HAUPTSCREEN_E.as_ptr() as _;
        file_size = HAUPTSCREEN_E.len() as _;
    }
...
pub unsafe extern "thiscall" fn class73_place_ui_element_hook(this: u32, zero: u32, class74: u32) {
    ...
    class73.set_x(0);
    class73.set_y(0);
    class73.set_width(1664);
    class73.set_height(936);
    class73.get_anim_0_1_2().get_screen_rectangle(0).set_width(1664);
    class73.get_anim_0_1_2().get_screen_rectangle(0).set_height(936);
