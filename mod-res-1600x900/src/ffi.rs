...
const RESOLUTION_STRING: &CStr = c"1600 x 900";
...
pub unsafe extern "thiscall" fn class73_place_ui_element_hook(this: u32, zero: u32, class74: u32) {
    ...
    class73.set_x(0);
    class73.set_y(0);
    class73.set_width(1600);
    class73.set_height(900);
    class73.get_anim_0_1_2().get_screen_rectangle(0).set_width(1600);
    class73.get_anim_0_1_2().get_screen_rectangle(0).set_height(900);
