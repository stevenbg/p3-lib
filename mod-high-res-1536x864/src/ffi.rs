...
const RESOLUTION_STRING: &CStr = c"1536 x 864";
...
static VOLLANSICHTSKARTE: &[u8] = include_bytes!("Vollansichtskarte1536.bmp");
static HAUPTSCREEN_A: &[u8] = include_bytes!("HauptscreenA1536.bmp");
static HAUPTSCREEN_E: &[u8] = include_bytes!("HauptscreenE1536.bmp");
...
pub unsafe extern "thiscall" fn class73_place_ui_element_hook(this: u32, zero: u32, class74: u32) {
    ...
    class73.set_x(0);
    class73.set_y(0);
    class73.set_width(1536);
    class73.set_height(864);
    class73.get_anim_0_1_2().get_screen_rectangle(0).set_width(1536);
    class73.get_anim_0_1_2().get_screen_rectangle(0).set_height(864);
